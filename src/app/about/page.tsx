  ...
  return (
    <Column maxWidth="m">
      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={100}>
          <Column
          ...
          >
            {about.calendar.display && (
              <Flex
                ...
                vertical="center"
              >
                <Icon paddingLeft="12" name="HiOutlineDocumentChartBar" onBackground="brand-weak" />
                <Flex paddingX="8">Download Resume</Flex>
                <IconButton
                  href="/resume/Krithik_Srinivas_Resume.pdf"
                  data-border="rounded"
                  variant="secondary"
                  icon="chevronRight"
